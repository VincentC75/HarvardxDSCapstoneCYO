...
rain <- rain %>%
  ...
  fill(WindGustSpeed, WindSpeed9am, WindSpeed3pm, Humidity9am, Humidity3pm, Rainfall, Pressure9am,
       Pressure3pm, MinTemp, MaxTemp, Temp9am, Temp3pm, WindGustDir, WindDir9am, WindDir3pm, .direction = "up")
rain <- rain %>% ungroup()
rain$Date <- NULL
...
```{r Temperature Correlation, message = FALSE, warning= FALSE, dev='png'}
library(dplyr)
library(corrplot)
